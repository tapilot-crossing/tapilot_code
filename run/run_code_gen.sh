...
python3 ./methods/tapilot_code_gen.py --data_path $data_path --output_path $output_path --private_lib_path $private_lib_path --llm_model_name $llm_model_name --model_version $model_version --api_key $api_key
